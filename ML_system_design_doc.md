...
- построен полностью автоматический pipeline
- достигнут ROC-AUC ≥ 0.90 или PR-AUC ≥ baseline ручной модели
- сформирован отчёт AutoML с логами экспериментов
...
(сумма, время суток, день недели,
канал, регион, тип операции)
        ↓
...
ROC-AUC / PR-AUC
        ↓
Подбор threshold
(фиксируем Precision или Recall)
        ↓
